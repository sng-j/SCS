 ...
 *
 * Pure function — shared by the vendor upload route (server) and the HwSlidePanel
 * renderer (client) so the same checks appear in both contexts without divergence.
 */
