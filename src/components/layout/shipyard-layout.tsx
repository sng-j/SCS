              ...
              {profileOpen && (
                ...
                >
                  ...
                  <button onClick={async () => {
                    // Same rationale as dashboard layout: NextAuth v5 drops a
                    // cross-origin callbackUrl and falls back to the current
                    // origin, sending 0.0.0.0 users to the non-routable
                    // 0.0.0.0/login. Sign out without redirect then navigate
                    // manually to the reachable origin.
